...
@section('content')
    ...
    <div class="breadcrumbs-area">
        ...
        <ul>
            ...
            <li>{{ isset($parent) ? 'Modifier un Parent' : 'Ajouter un Parent' }}</li>
        </ul>
    </div>
    <!-- Breadcubs Area End Here -->
    <!-- Add/Edit Parent Area Start Here -->
    <div class="card height-auto">
        <div class="card">
            <div class="card-body">
                <div class="heading-layout1">
                    <div class="item-title">
                        <h3>{{ isset($parent) ? 'Modifier un Parent' : 'Ajouter un nouveau Parent' }}</h3>
                    </div>
                    <div class="dropdown">
                ...
                <form class="new-added-form" method="POST" action="{{ isset($parent) ? route('parents.update', ['parent' => $parent->id]) : route('parents.store') }}">
                    @csrf
                    @if(isset($parent))
                        @method('PUT')
                    @endif
                    <div class="row">
                        ...
                        <div class="col-12 form-group mg-t-8">
                            <button type="submit" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">
                                {{ isset($parent) ? 'Mettre à jour' : 'Enregistrer' }}
                            </button>
